...
export const profile = {
  ...
  headline: 'Vue.js • Nuxt.js • React • Angular',
  location: 'Nova Petrópolis, RS',
  email: 'everton-adams@hotmail.com',
  phone: '(54) 99173-2802',
  availability: 'Disponível para projetos',
  bio:
    'Desenvolvedor Front-end com mais de 4 anos de experiência na criação de interfaces modernas, performáticas e centradas no usuário. Atuo principalmente com Vue.js e Nuxt.js, com vivência em React, Next.js e Angular — sempre com foco em performance, acessibilidade, SEO, componentização escalável e qualidade via testes automatizados.',
  intro:
...
export const socialLinks: SocialLink[] = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/evertonra/', icon: 'linkedin' },
...
export const stats: Stat[] = [
  ...
  },
  {
    ...
    description: 'Nas entregas com automação e componentização',
  },
  {
    value: '40%',
    label: 'Menos tempo de dev',
    description: 'Redução no ciclo de desenvolvimento',
  },
  {
    value: '100',
    label: 'Lighthouse',
...
export const projects: Project[] = [
  {
    ...
    description: 'Portal corporativo desenvolvido com Nuxt.js, focado em performance e SEO.',
  ...
  },
  {
    ...
    description: 'Plataforma SaaS para gestão comercial com interface responsiva e integração via API.',
  ...
  },
  {
    ...
    description: 'Página otimizada para conversão e geração de leads qualificados.',
  ...
  },
  {
    ...
    description: 'Página de vendas com foco em copy, UX e performance para produto digital.',
  ...
  },
  {
    ...
    category: 'Incligeo',
    title: 'Site institucional',
    description: 'Presença digital corporativa com arquitetura escalável e design moderno.',
  ...
  },
  {
    ...
    description: 'Página de vendas para produto digital com alta taxa de conversão.',
  ...
  },
  {
    ...
    title: 'Landing page de ebook',
    description: 'Experiência de compra fluida com design persuasivo e mobile-first.',
  ...
  },
  {
    ...
    title: 'Landing page de ebook',
    description: 'Página de lançamento com estrutura otimizada para campanhas digitais.',
...
export const skillGroups: SkillGroup[] = [
  {
    title: 'Front-end',
    items: ['Vue.js', 'Nuxt.js', 'React.js', 'Next.js', 'Angular'],
  },
  {
...
export const services: Service[] = [
  {
    title: 'Landing Pages',
    description: 'Páginas otimizadas para conversão, com código personalizado e máxima performance.',
    icon: 'rocket',
  },
  {
    title: 'Sites Institucionais',
    description: 'Sites completos, modernos e responsivos para apresentar sua marca com autoridade.',
    icon: 'building',
  },
  {
    title: 'Sistemas sob demanda',
    description: 'Desenvolvimento personalizado com integração via API — portais, painéis e SaaS.',
    icon: 'code',
  },
]
